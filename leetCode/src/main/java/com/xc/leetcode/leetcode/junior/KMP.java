...
//        String needle = "ABCABXYABCABATDM";
        String needle = "ABABADAC";
        int[] next = new int[needle.length()];
        int[] next2 = new int[needle.length()];
        int[] next3 = new int[needle.length()];
        getNext(needle,next);
        getNext2(needle,next2);
        getNext3(needle,next3);
        System.out.println();
    }
...
//        0 0 1 2 3 1
    ...
    private static void getNext2(String p, int next[]) {
//        A B A B A A C
//        0 0 1 2 3 1
//        0 1 2 3 4 5 6
        int pLen = p.length();
